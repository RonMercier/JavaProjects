...
public class ModifyProductController implements Initializable {
    ...
    /**
     * Declaring Product as selectedProduct to pull data from the Product table.
     *
     * */
    ...
    /**
     * The text field for the product stock.
     * */
    @FXML
    private TextField ModifyProductStockTxt;
    /**
    ...
    void SearchPart(ActionEvent event) {
        ...
        if (SearchPartsTxt.getText().isEmpty() || partSearch.isEmpty()) {
            formError(2);
        }
    }
    ...
    /**
     * Action event that updates a selected product to the inventory and loads
    ...
    void SaveProduct(ActionEvent event) throws IOException {
        try {
            ...
            int stock = Integer.parseInt(ModifyProductStockTxt.getText());
     ...
     * @return Boolean Indicates if the product is valid.
     *
     * */
    ...
    /**
     *
     * Initializes the Modify Product Controller and populates the tables.
     *
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        selectedProduct = MainScreenController.getModProduct();
        addedParts = selectedProduct.getAllAssociatedParts();
        ...
        ModifyProductStockTxt.setText(Integer.toString(selectedProduct.getStock()));
        ModifyProductPriceTxt.setText(Double.toString(selectedProduct.getPrice()));
        ModifyProductMaxTxt.setText(Integer.toString(selectedProduct.getMax()));
        ModifyProductMinTxt.setText(Integer.toString(selectedProduct.getMin()));
