...
/**
 * Controller class that controls the Modify Part screen of the Inventory Application.
 *
 * @author Ron Mercier
 *
 * */
public class ModifyPartController implements Initializable {
    ...
    /**
     * The part object declared in the MainScreenController
     * */
     ...
     * */
    @FXML
    void ModPartInHouse(MouseEvent event) {
     ...
     * */
    @FXML
    void ModPartOutSourced(MouseEvent event) {
      PartLocationLbl.setText("Company Name:");
  }
    /**
     * Action event that saves an updated part to the inventory and loads
     * the main screen once part is saved.
     *
     * Fields are validated with error messages to prevent saving invalid and/or empty values.
     *
     ...
     * @return Boolean Indicates if the part is valid.
     *
     * */
    ...
    /**
     * Initializes the Modify Part Controller and disables the text field of the part ID.
     *
     *
    ...
    public void initialize(URL location, ResourceBundle resourceBundle) {
        selectedPart = MainScreenController.getModPart();

        if (selectedPart instanceof InHouse) {
            InHouseBtn.setSelected(true);
            PartLocationLbl.setText("Machine ID:");
            PartLocationTxt.setText(String.valueOf(((InHouse) selectedPart).getMachineId()));
        }
        if (selectedPart instanceof Outsourced) {
            OutsourcedBtn.setSelected(true);
            PartLocationLbl.setText("Company Name");
            PartLocationTxt.setText(((Outsourced) selectedPart).getCompanyName());
